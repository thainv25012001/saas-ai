...
(`docker compose exec -T api uv run python -m app.db.seed`), the seed already enables the
demo agent's widget for `http://localhost:5500` and prints the exact URL to open. Then:

...
| `make test` | Runs the backend test suite (450 tests: unit + integration, incl. tenant isolation, RLS, the chat/streaming suites, and the RAG ingestion pipeline). | `cd apps/api && uv run pytest -v` |

...
export type AgentQuery = { agent: { id: string, name: string, slug: string, status: AgentStatus, provider: string, model: string, temperature: number, maxTokens: number, promptId: string | null, config: { id: string, tone: string, language: string, persona: string | null, greeting: string | null, fallbackMessage: string, retrievalTopK: number, maxAgentSteps: number } | null } };

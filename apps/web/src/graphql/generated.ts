...
export type ConversationQuery = { conversation: { id: string, title: string | null, messages: Array<{ id: string, seq: number, role: MessageRole, content: string | null, model: string | null, inputTokens: number | null, outputTokens: number | null, costUsd: string | null, latencyMs: number | null, error: string | null, citations: Array<{ chunkId: string | null, documentId: string | null, documentTitle: string, excerpt: string, rank: number, score: number }> }> } | null };

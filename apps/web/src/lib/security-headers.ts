 ...
 * `middleware.ts`. That middleware is matched to `/dashboard/:path*`, and
 * widening it to every route would put a function invocation in front of all
 * static traffic purely to set six constants.
 */
